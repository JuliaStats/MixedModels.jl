...
lmm₁ = fit(lmm(Yield ~ 1 | Batch,ds));

@test_approx_eq_eps lmm₁[:θ] [0.752580] 1.e-5
...
@test_approx_eq_eps MixedModels.LD(lmm₁) 8.060146250122475 1.e-8
@test_approx_eq_eps varest(lmm₁) 2451.2505033164093 1.e-3
@test_approx_eq_eps pwrss(lmm₁) 73537.50076827034 1.e-2
@test_approx_eq_eps stderr(lmm₁) [17.69455309235944] 1.e-7
