...
@testset "sleep" begin
    ...
    @test vcov(fm) ≈ [43.986843599069985 -1.370391879315539; -1.370391879315539 2.2567113314443645] atol=0.0001
    @test vcov(fm,corr=true) ≈ [1.0 -0.1375451787621904; -0.1375451787621904 1.0] atol=0.0001
